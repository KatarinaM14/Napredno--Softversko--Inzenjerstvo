...
console.log(arrivalMessages)
  ...
  useEffect(() => {
    connection?.on('OpenPrivateChat', (privateMessage) =>{
      console.log('private chat')
      currentChat?.members?.includes(privateMessages.sender) && setPrivateMessages([...privateMessages, privateMessage])
  ...
  useEffect(() => {
    connection?.on('NewPrivateMessage', (privateMessage) =>{
  ...
  const handleSubmit = async (e) => {
    ...
    // if(!privateMessageInitiated){
      ...
      //   await connection?.invoke("CeatePrivateChat", message)
      //   //.then(() => {
        //     //setPrivateMessages([...privateMessages, messages])
        //   //})
        //   .catch(console.error());
        // }else{
          //   await connection?.invoke("ReceivePrivateMessage", message).catch(console.error());
          // }
          // sendMsg();
